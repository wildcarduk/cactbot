  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Echoes from Time\'s Garden': 'Jardin d\'un autre temps dans',
        'Famfrit, The Darkening Cloud': 'Famfrit le Nuage Ténébreux',
        '(?<! )Gigas': 'serviteur de Bélias',
        'Heart of the Dragon': 'cœur de Yiazmat',
        'Missile': 'Missile',
        'The Cleft of Profaning Wind': 'la corniche des Vents distordants dans',
        'The Clockwork Coliseum': 'l\'arène de Goug dans',
        'The Spire\'s Bounds': 'l\'orée des Cieux dans',
